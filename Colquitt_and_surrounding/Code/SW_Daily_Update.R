...
write.csv(countsToBeUpdated, "Colquitt_and_surrounding/Data/ACC Healthcare Region Simulation  - Case Counts by County GA.csv", row.names = F)
...
write.csv(primSecCounties, "Colquitt_and_surrounding/Data/SW_primary and secondary counties cases.csv", row.names = F)
