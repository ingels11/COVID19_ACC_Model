...
model_hospitalizations <- function(data, hc_params) {
...
summarise_model_hospitalizations <- function(model_res, hc_params) {
...
hospital_capacity <- function(res_sum, hc_params) {
